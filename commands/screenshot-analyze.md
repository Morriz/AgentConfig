...
1. **Handle Screenshot Input**: If a screenshot path is provided in arguments, use that file. If no path is provided, execute `ls -t /Users/Morriz/Library/CloudStorage/Dropbox/Screenshots | head -n 1` to use the most recent one, or follow instructions in extra context.
